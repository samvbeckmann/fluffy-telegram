...
class Environment
{
    ...
    {
        double prob = 0;
        String xPlayerString = "MinimaxTicTacToePlayer";
        String oPlayerString = "QLearningPlayer";
        int rounds = 1000000;
        boolean print = false;
        boolean stats = true;
        ...
        final String packagePath = "com.natebeckemeyer.school.machinelearning.reinforcement.";
        try
        {
            xPlayer = (TicTacToePlayer) (cl.loadClass(
                    "com.samvbeckmann.machinelearning.reinforcement.players.MinimaxTicTacToePlayer").newInstance());
            oPlayer = (TicTacToePlayer) (cl.loadClass(
                    "com.natebeckemeyer.school.machinelearning.reinforcement.QLearningPlayer").newInstance());
    ...
    private void runSimulation()
    {
        ...
        {
            winArray[i - 1] = runGame(new RandomMinimaxTicTacToePlayer());
            if (stats && (i & (i - 1)) == 0) // A power of 2
                System.out.println(getStatsString(i) + '\n');
        }

        if (stats) System.out.print(getStatsString(rounds));
    }
     ...
     */
    private String getStatsString(int numPassed)
    {
